...
func (p *ProfileService) UpdateProfile(ctx context.Context, newProfile models.Profile) error {
    ...
    if err != nil {
        return fmt.Errorf("p.repo.UpdateProfileTextInfo: %w", err)
    }
    ...
    if newProfile.Avatar != nil {
        ...
        if err != nil {
            return fmt.Errorf("p.repo.UpdateProfileAvatar: %w", err)
        }
    }
    ...
    if newProfile.Background != nil {
        ...
        if err != nil {
            return fmt.Errorf("p.repo.UpdateProfileCover: %w", err)
        }
    }
