...
const (
	FeedbackService_GetFeedbackList_FullMethodName = "/feedback.FeedbackService/GetFeedbackList"
	FeedbackService_SaveFeedback_FullMethodName    = "/feedback.FeedbackService/SaveFeedback"
)
...
type FeedbackServiceClient interface {
	GetFeedbackList(ctx context.Context, in *GetFeedbackRequest, opts ...grpc.CallOption) (*GetFeedbackListResponse, error)
	SaveFeedback(ctx context.Context, in *SaveFeedbackRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *feedbackServiceClient) GetFeedbackList(ctx context.Context, in *GetFeedbackRequest, opts ...grpc.CallOption) (*GetFeedbackListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFeedbackListResponse)
	err := c.cc.Invoke(ctx, FeedbackService_GetFeedbackList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedbackServiceClient) SaveFeedback(ctx context.Context, in *SaveFeedbackRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type FeedbackServiceServer interface {
	GetFeedbackList(context.Context, *GetFeedbackRequest) (*GetFeedbackListResponse, error)
	SaveFeedback(context.Context, *SaveFeedbackRequest) (*emptypb.Empty, error)
...
func (UnimplementedFeedbackServiceServer) GetFeedbackList(context.Context, *GetFeedbackRequest) (*GetFeedbackListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFeedbackList not implemented")
}
func (UnimplementedFeedbackServiceServer) SaveFeedback(context.Context, *SaveFeedbackRequest) (*emptypb.Empty, error) {
...
func _FeedbackService_GetFeedbackList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FeedbackService_GetFeedbackList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedbackServiceServer).GetFeedbackList(ctx, req.(*GetFeedbackRequest))
	}
